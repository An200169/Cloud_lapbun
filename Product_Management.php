    ...
    <link rel="stylesheet" href="css/bootstrap.min.css">
        ...
        <table id="tableproduct" class="table table-striped table-bordered" cellspacing="0" width="100%">
			...
			<tr>
             ...
             <td align='center' class='cotNutChucNang'><a href="?page=editproduct&&id=<?php echo $row["Product_ID"]; ?>"><img src='images/edit.png' border='0'/></a></td>
             <td align='center' class='cotNutChucNang'><a href="?page=product&&function=del&&id=<?php echo $row["Product_ID"];?>"onclick="return deleteconfirm()"><img src='images/delete.png' border='0' /></a></td>
            </tr>
            <?php
               $No++;
                }
